...
@Yonebot.on_message(filters.command("song") & ~filters.channel)
def song(client, message):
    ...
    try:
        ...
        rep = "**🎵 Uploaded by [𝐘𝐨𝐧𝐞 𝐌𝐮𝐬𝐢𝐜 𝐁𝐨𝐭🎶🎸](https://t.me/KoraSupport)**"
...
@Yonebot.on_message(filters.command("saavn") & ~filters.edited)
...
@Yonebot.on_message(filters.command("deezer") & ~filters.edited)
...
@Yonebot.on_message(filters.command(["vsong", "video"]))
